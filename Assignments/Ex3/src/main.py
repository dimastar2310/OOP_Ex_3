#import switch as switch i this one 
...
def check1():
    ...
    file = r"D:\DIMA\Desktop\OOP-main\Assignments\Ex3\data\A0.json"
...
def check2():
    """ This function tests the naming, basic testing over A5 json file.
      ...
      """
    g_algo = GraphAlgo()
    file = r"D:\DIMA\Desktop\OOP-main\Assignments\Ex3\data\A5.json"
    g_algo.load_from_json(file)
    g_algo.get_graph().remove_edge(13, 14)
    g_algo.save_to_json(file + "_edited")
    print("check2")
    dist, path = g_algo.shortest_path(1, 7) #we return number and list
    print(dist, path)
    ...
    print(dist, path)
    print("and the tsp is:")
    print(g_algo.TSP([1, 2, 3])) #ma hamaslus hahi kazar she over bein kodkodim haele?
    g_algo.plot_graph()
